...
import { create as createListing } from '@/lib/queries/listing.queries';
...
type Inferred = z.infer<typeof formSchema>;

type FormValues = Inferred;
...
export default function CreateListingForm() {
  ...
  const onSubmit: SubmitHandler<Partial<FormValues>> = async (values) => {
    ...
    try {
      await createListing(
        {
          carModificationId: values.modificationId as number,
          price: values.price as number,
          mileage: values.mileage as number,
